...
\begin{thm}[Sistema caratteristico]
...
\right.
\end{equation*}
ammette come soluzione intera solo \[\begin{cases}
	h=1\\
	k=1\\
\end{cases}\]
\end{thm}
...
\end{array}
\right.\]
Quindi la successione è di Fibonacci ordinaria.
\end{proof}
Utilizzando il~\vref{thm:FibdispariGen} e il~\vref{thm:Fibdispari} otteniamo
\begin{thm}
	\begin{equation}
		\Gib{n}^2+\Gib{n+1}^2=\Gib{2n+1} 
	\end{equation} se e solo la successione è la successione ordinaria di Fibonacci. 
\end{thm}