...
Dato un trinagolo, se $2p=a+b+c$ allora l'area del triangolo è \[A=\sqrt{p(p-a)(p-b)(p-c)}\]
\end{thm}\index{Triangolo!Erone}
\begin{proof}
...
\intertext{Per esprire l'altezza in funzione dei lati sostiuiamo il risultato precedente nell'~\cref{eqn:erone1}}
