...
\end{defn}
\begin{defn}[Media armonica]\index{Media!armonica}\label{defn:mediarmonica}
	Dato un insieme di valori $\lbrace x_i \rbrace$ la media armonica è\[M=\dfrac{n}{\sum_{i=1}^{n}\dfrac{1}{x_{i}}}\]
\end{defn}
\section{Varianza}
