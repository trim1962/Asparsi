...
\begin{figure}
	...
	\label{fig:excentro1}
\end{figure}
\begin{thm}[Raggio della circonferenza exinscritta]
	Dato un triangolo di area $A$ e perimetro $2p$ se i  lati sono $a$, $b$ e $c$ allora il raggio della circonferenza exinscritta è:
	\[R=\dfrac{A}{p-a}=\dfrac{A}{p-b}=\dfrac{A}{p-c}\]
...
\end{figure}
\begin{proof}
Consideriamo la~\cref{fig:triangoloexraggio}. Possiamo dire che:
\begin{align*}
