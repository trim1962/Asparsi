...
\draw (7.2,0.7) node {$B$};
\draw [fill=black] (4.226204810235532,7.183752003695065) circle [radius=2.0pt];
\draw (4.5,7.8) node {$C$};
\draw [fill=black] (-4.517678489481885,7.899228118691028) circle [radius=2.0pt];
\draw (-4.2,8.4) node {$D$};
\draw [fill=black] (3.1829859367448132,-5.565498313231292) circle [radius=2.0pt];
\draw (3.4,-5.0) node {$E$};
\draw [fill=black] (11.517678489481884,6.587120612149493) circle [radius=2.0pt];
\draw (11.8,7.2) node {$F$};
\draw [fill=black] (3.817014063255187,2.1830034616692773) circle [radius=2.0pt];
\draw (4.1,2.8) node {$G$};
\end{scriptsize}
\end{axis}
\end{tikzpicture}
