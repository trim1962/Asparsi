...
\begin{comm}
	...
	\end{description}
\end{comm}
\begin{thm}\label{thm:scompsecgrad2}\index{Triniomio!secondo!grado}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}\label{thm:scompsecgrad3}\index{Triniomio!secondo!grado}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}\label{thm:scompsecgrad4}\index{Triniomio!secondo!grado}
	Se esistono due numeri $t_1$ e $t_2$ tali che\begin{equation}
	\begin{cases}
	s=t_1+t_2\\
	p=t_1\cdot t_2
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}\label{thm:scompsecgrad5}\index{Triniomio!secondo!grado}
	Se esistono due numeri $t_1$ e $t_2$ tali che\begin{equation}
	\begin{cases}
	s=t_1+t_2\\
	ap=t_1\cdot t_2
