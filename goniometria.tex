...
\begin{proof}
	...
	Da cui la tesi.
\end{proof}
\section{Formule di triplicazione}
\begin{thm}[Formula di triplicazione del coseno]\label{thm:Formulatriplicazionecoseno}
	Dato un angolo $\alpha$ avremo:
	\[\cos 3x=4\cos^3x-3\cos x\]
\end{thm}\index{Coseno:triplicazione}
\begin{proof}
	\begin{align*}
		\cos 3x=&\cos(2x+x)\\
...
\end{proof}
\begin{thm}[Formula di triplicazione del seno]\label{thm:Formulatriplicazioneseno}
	Dato un angolo $\alpha$ avremo:
	\[\sin 3x=3\sin x-4\sin^3 x\]
\end{thm}\index{Seno:triplicazione}
\begin{proof}
	\begin{align*}
		\sin 3x=&\sin(2x+x)\\
...
Come volevasi dimostrare.
\end{proof}
\section{Formule di dimezzamento}
\begin{cor}[Coseno angolo metà]\label{cor:Cosenoangolometa}
	Dato un angolo $\alpha$ avremo:
	\[\cos\alpha=2\cos^2\dfrac{\alpha}{2}-1\]
\end{cor}\index{Coseno!dimezzamento}
\begin{proof}
	...
	Come volevasi dimostrare.
\end{proof}
\begin{cor}[Seno angolo metà]\label{cor:Senoangolometa}
	Dato un angolo $\alpha$ avremo:
	\[\sin\alpha=2\sin\dfrac{\alpha}{2}\cos\dfrac{\alpha}{2}\]
\end{cor}\index{Seno!dimezzamento}
\begin{proof}
	...
	Come volevasi dimostrare.
\end{proof}
\begin{cor}[Seno in funzione del coseno dell'angolo metà]\label{cor:Senoangolometacoseno}
	Dato un angolo $\alpha$ avremo:
	\[\sin^2\dfrac{\alpha}{2}=\dfrac{1-\cos\alpha}{2}\]
\end{cor}\index{Seno!coseno!dimezzamento}
\begin{proof}
	Segue facilmente dal~\vref{thm:Formulediduplicazionecoseno}. 
	\begin{align*}
		\cos 2\alpha=&\cos^2\alpha-\sin^2\alpha\\
