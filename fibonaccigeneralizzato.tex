...
\end{thm}
\begin{proof}
\begin{align*}\Gib{n}^2+\Gib{n+1}^2-\Gib{2n+1}=&a^{2(n-1)}\dfrac{\lbrace a^3+bh-k+a^2\left[b\left(h-1\right)-k\right]\rbrace}{(a-b)^2}+b^{2(n-1)}\dfrac{\lbrace a^3+a^2\left[b\left(h-1\right)-k\right]+bh-k\rbrace}{(a-b)^2}\\
\end{align*}
\end{proof}