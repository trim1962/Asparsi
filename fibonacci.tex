...
\begin{thm}[Formula di Binet]~\cite{Conti2020}\index{Formula!Binet!Fibonacci}
...
cvd.
\end{proof}
\begin{thm}[Fibonacci e Lucas negativo]~\cite{Rabinowitz_1996}\label{thm:FibLucNeg}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}[Relazione fondamentale fra Lucas e Fibonacci]~\cite{Rabinowitz_1996}
	Se $\Fib{n}$ è la successione di Fibonacci e  $\Luc{n}$ è quella di Lucas allora:
	\begin{equation}
...
\end{proof}
\section{Conversione}
\begin{thm}[Converti in Fibonacci o in Lucas]~\cite{Rabinowitz_1996}
	Se $\Fib{n}$ è la successione di Fibonacci e  $\Luc{n}$ è quella di Lucas allora:
	\begin{align}
...
\Luc{n}^3={}&\Luc{3n}+3(-1)^n\Luc{n}\label{eqn:LucCubSomma}\\
	...
	\Fib{n}^5={}&\dfrac{\Fib{5n}-5(-1)^n\Fib{3n}+10\Fib{n}}{25}\label{eqn:FibQuintaaSomma}\\
	\Luc{n}^5={}&\Luc{5n}+5(-1)^n\Luc{3n}+10\Luc{n}\label{eqn:LucQuintaaSomma}\\
...
\begin{align*}
	...
	\intertext{per il~\vref{eqn:FibQuintaaSomma}}
...
\Luc{n}^2={}&\Luc{2n}+2(-1)^n
\intertext{Quindi}
={}&\Luc{5n}+(-1)^{n}\Luc{4n}+5(-1)^n[\Luc{4n}+(-1)^{n}\Luc{2n}]+10[\Luc{4n}+(-1)^{n}\Luc{2n}]\\
={}&\Luc{6n}+(-1)^{n}\Luc{4n}+5(-1)^n\Luc{4n}+5(-1)^{2n}\Luc{2n}+10\Luc{4n}+20(-1)^{n}\Luc{2n}\\
