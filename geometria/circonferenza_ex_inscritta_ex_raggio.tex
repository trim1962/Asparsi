...
\draw[color=ududff] (7.254178633946865,5.678290329015679) node {$A$};
\draw [fill=uuuuuu] (0.,0.) circle (2.0pt);
\draw[color=uuuuuu] (0.20420774799209745,-0.7002547582767393) node {$B$};
\draw [fill=xdxdff] (12.,0.) circle (2.5pt);
\draw[color=xdxdff] (12.066063524360436,-0.8121590580537992) node {$C$};
...
\draw [fill=uuuuuu] (13.83669653945405,4.4341776955137) circle (2.0pt);
\draw[color=uuuuuu] (14.080340920347512,5.04416596361234) node {$D$};
\draw [fill=uuuuuu] (11.259383105084162,8.042416503631543) circle (2.0pt);
\draw[color=uuuuuu] (11.506542025475136,8.66240498973728) node {$E$};
\draw [fill=uuuuuu] (13.836696539454051,0.) circle (2.0pt);
\draw[color=uuuuuu] (14.080340920347512,0.6052954057889606) node {$F$};
...
\draw [fill=uuuuuu] (10.701259421970173,1.2987405780298258) circle (2.0pt);
\draw[color=uuuuuu] (10.947020526589837,1.9108455698546605) node {$G$};
