...
\begin{cor}[Formule moltiplicazione scalare]\label{thm:LucFibmoltscalare}
	Se $\Fib{n}$ è la successione di Fibonacci e  $\Luc{n}$ è quella di Lucas allora:
	\begin{equation}
...
\begin{cor}[Potenze in somma]\label{thm:FibpotSomma}
	Se $\Fib{n}$ è la successione di Fibonacci e  $\Luc{n}$ è quella di Lucas allora:
	\begin{equation}
...
\intertext{posto}
m=&n\\
\Fib{2n}\Fib{n}=&\dfrac{\Luc{n+2n}-(-1)^n\Luc{2n-n}}{5}
\end{align*}
\end{proof}