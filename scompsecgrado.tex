...
Dato un trinomio di secondo grado\index{Trinomio!secondo!grado} $ax^2+bx+c=0$ con $a\neq 0$ avremo:\begin{equation}
...
\begin{commento}[Applicazione scomposizione trinomio secondo grado]
	...
	\end{description}
\end{commento}
\begin{thm}[Scomposizione tramite due numeri]\label{thm:scompsecgrad2}\index{Trinomio!secondo!grado}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}[Scomposizione tramite somma e prodotto]\label{thm:scompsecgrad3}\index{Trinomio!secondo!grado}
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}[Scomposizione tramite somma e prodotto di due numeri]\label{thm:scompsecgrad4}\index{Trinomio!secondo!grado}
	Se esistono due numeri $t_1$ e $t_2$ tali che\begin{equation}
	\begin{cases}
	s=t_1+t_2\\
	p=t_1\cdot t_2
...
\begin{proof}
	...
	\end{align*}
\end{proof}
\begin{thm}[Scomposizione tramite somma e prodotto di due numeri. Caso generale]\label{thm:scompsecgrad5}\index{Trinomio!secondo!grado}
	Se esistono due numeri $t_1$ e $t_2$ tali che\begin{equation}
	\begin{cases}
	s=t_1+t_2\\
	ap=t_1\cdot t_2
