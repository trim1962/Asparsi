...
\end{figure}
\begin{thm}[Area triangolo]\label{thm:areatriangoloseno}
	...
	\end{align*}
\end{thm}\index{Triangolo!area}\index{Seno!area}
\begin{figure}
	\centering
	\includestandalone{geometria/areatrigonometricatriangolo}
